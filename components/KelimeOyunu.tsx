...
const KELIMELER = {
  ...
  tema2: { ad: "Aile ve Arkadaşlar", kelimeler: [
    ...
    {de:"die Hochzeit",tr:"düğün"},{de:"gestorben",tr:"ölmüş, vefat etmiş"},
    {de:"tot",tr:"ölü, hayatta olmayan"},{de:"leben",tr:"yaşamak"},
    {de:"das Leben",tr:"hayat, yaşam"},{de:"beide",tr:"her ikisi de"},
    {de:"der Mensch",tr:"insan"},{de:"die Leute",tr:"insanlar, halk"},
    {de:"erzählen",tr:"anlatmak"},{de:"lachen",tr:"gülmek"},
    {de:"böse",tr:"kızgın, sinirli"},{de:"lieb",tr:"sevgili, tatlı"},
    {de:"nett",tr:"nazik, hoş"},{de:"groß",tr:"büyük, uzun boylu"},
    {de:"klein",tr:"küçük"},{de:"jung",tr:"genç"},{de:"alt",tr:"yaşlı, eski"},
  ...
  tema3: { ad: "Meslek", kelimeler: [
    ...
    {de:"die Lösung",tr:"çözüm, cevap"},{de:"richtig",tr:"doğru"},
    {de:"falsch",tr:"yanlış"}
  ]},
  tema4: { ad: "Günlük Hayat", kelimeler: [
    ...
    {de:"der Alltag",tr:"günlük hayat"},{de:"die Routine",tr:"rutin"},
    {de:"waschen",tr:"yıkamak"},{de:"sich duschen",tr:"duş almak"},
    {de:"die Dusche",tr:"duş"},{de:"das Bad",tr:"banyo"},
    {de:"putzen",tr:"temizlemek"},{de:"kochen",tr:"yemek pişirmek"},
    {de:"einkaufen",tr:"alışveriş yapmak"},{de:"der Haushalt",tr:"ev işleri, hane"},
    {de:"die Waschmaschine",tr:"çamaşır makinesi"},{de:"die Maschine",tr:"makine"},
    {de:"anfangen",tr:"başlamak"},{de:"aufhören",tr:"bitmek, durmak"},
    {de:"warten",tr:"beklemek"},{de:"dauern",tr:"sürmek"},
    {de:"die Sekunde",tr:"saniye"},{de:"die Minute",tr:"dakika"},
    {de:"die Stunde",tr:"saat (süre)"},{de:"der Tag",tr:"gün"},
    {de:"die Woche",tr:"hafta"},{de:"das Jahr",tr:"yıl"},
    {de:"der Wochentag",tr:"hafta günü"},{de:"das Wochenende",tr:"hafta sonu"},
    {de:"der Feiertag",tr:"resmi tatil günü"}
  ]},
  tema5: { ad: "Yemek ve İçecek", kelimeler: [
    ...
    {de:"das Lokal",tr:"meyhane, restoran"},{de:"die Speisekarte",tr:"menü, yemek listesi"},
    {de:"bestellen",tr:"sipariş vermek"},{de:"bezahlen",tr:"ödemek"},
    {de:"die Rechnung",tr:"hesap, fatura"},{de:"bitter",tr:"acı"},
    {de:"süß",tr:"tatlı"},{de:"salzig",tr:"tuzlu"},
    {de:"der Hunger",tr:"açlık"},{de:"der Durst",tr:"susuzluk"},
    {de:"das Frühstück",tr:"kahvaltı"},{de:"das Mittagessen",tr:"öğle yemeği"},
    {de:"das Abendessen",tr:"akşam yemeği"},{de:"die Mahlzeit",tr:"öğün, yemek vakti"},
    {de:"kochen",tr:"pişirmek"},{de:"grillen",tr:"mangal yapmak"},
  ...
  tema6: { ad: "Alışveriş", kelimeler: [
    ...
    {de:"der Prospekt",tr:"broşür, katalog"},{de:"das Prozent",tr:"yüzde"},
    {de:"die Lebensmittel",tr:"gıda maddeleri"},{de:"der Markt",tr:"pazar, market"},
    {de:"umziehen",tr:"değiştirmek (kıyafet)"},{de:"anziehen",tr:"giymek"},
    {de:"ausziehen",tr:"çıkarmak (kıyafet)"},{de:"passen",tr:"uymak, yakışmak"},
    {de:"die Farbe",tr:"renk"},{de:"schwarz",tr:"siyah"},
    {de:"weiß",tr:"beyaz"},{de:"rot",tr:"kırmızı"},
    {de:"blau",tr:"mavi"},{de:"grün",tr:"yeşil"},
    {de:"gelb",tr:"sarı"},{de:"grau",tr:"gri"},
    {de:"braun",tr:"kahverengi"},{de:"die Währung",tr:"para birimi"},
    {de:"wechseln",tr:"değiştirmek, bozmak"},{de:"die Bank",tr:"banka"},
    {de:"überweisen",tr:"havale etmek"},{de:"das Konto",tr:"banka hesabı"}
  ]},
  tema7: { ad: "Ev ve Yaşam", kelimeler: [
    ...
    {de:"der Schlüssel",tr:"anahtar"},{de:"die Adresse",tr:"adres"},
    {de:"die Postleitzahl",tr:"posta kodu"},{de:"das Apartment",tr:"daire"},
    {de:"das Doppelzimmer",tr:"çift kişilik oda"},{de:"das Einzelzimmer",tr:"tek kişilik oda"},
    {de:"das Dorf",tr:"köy"},{de:"die Stadt",tr:"şehir"},
    {de:"die Straße",tr:"sokak, cadde"},{de:"die Hausnummer",tr:"kapı numarası"},
    {de:"der Eingang",tr:"giriş"},{de:"der Ausgang",tr:"çıkış"},
    {de:"ruhig",tr:"sessiz, sakin"},{de:"laut",tr:"gürültülü, yüksek sesle"},
    {de:"hell",tr:"aydınlık"},{de:"das Fenster",tr:"pencere"},
    {de:"die Tür",tr:"kapı"},{de:"öffnen",tr:"açmak"},
    {de:"schließen",tr:"kapatmak"},{de:"an sein",tr:"açık olmak (ışık vb.)"},
    {de:"aus sein",tr:"kapalı olmak"},{de:"auf sein",tr:"açık olmak (kapı vb.)"},
    {de:"zu sein",tr:"kapalı olmak (kapı vb.)"},{de:"der Drucker",tr:"yazıcı"},
    {de:"der Computer",tr:"bilgisayar"},{de:"anmachen",tr:"açmak (cihaz)"},
    {de:"ausmachen",tr:"kapatmak (cihaz)"}
  ]},
  tema8: { ad: "Boş Zaman", kelimeler: [
    ...
    {de:"das Interesse",tr:"ilgi, merak"},{de:"interessant",tr:"ilginç"},
    {de:"kulturell",tr:"kültürel"},{de:"das Museum",tr:"müze"},
    {de:"besichtigen",tr:"gezmek, ziyaret etmek"},{de:"die Führung",tr:"rehberli tur"},
    {de:"die Sehenswürdigkeit",tr:"turistik yer"},{de:"fotografieren",tr:"fotoğraf çekmek"},
    {de:"das Foto",tr:"fotoğraf"},{de:"der Gast",tr:"misafir"},
    {de:"einladen",tr:"davet etmek"},{de:"die Einladung",tr:"davet"},
    {de:"treffen",tr:"buluşmak"},{de:"sich treffen",tr:"buluşmak"},
    {de:"der Termin",tr:"randevu"},{de:"die Veranstaltung",tr:"etkinlik"},
    {de:"das Konzert",tr:"konser"},{de:"das Theater",tr:"tiyatro"},
    {de:"der Eintritt",tr:"giriş ücreti"},{de:"die Karte",tr:"bilet"},
    {de:"Spaß machen",tr:"eğlenceli olmak"},{de:"gefallen",tr:"beğenmek, hoşuna gitmek"},
    {de:"mögen",tr:"sevmek, hoşlanmak"},{de:"gern",tr:"memnuniyetle, severek"}
  ]},
  tema9: { ad: "Ulaşım ve Yol Tarifi", kelimeler: [
    ...
    {de:"der Lkw",tr:"kamyon"},{de:"der Anschluss",tr:"aktarma (ulaşım)"},
    {de:"das Gleis",tr:"ray, peron numarası"},{de:"halten",tr:"durmak"},
    {de:"umsteigen",tr:"aktarma yapmak"},{de:"die Durchsage",tr:"anons"},
    {de:"der Automat",tr:"otomat"},{de:"der Schalter",tr:"gişe, gişe"},
    {de:"die Auskunft",tr:"bilgi, danışma"},{de:"fragen",tr:"sormak"},
    {de:"der Plan",tr:"plan, harita"},{de:"zeigen",tr:"göstermek"},
    {de:"der Kilometer",tr:"kilometre"},{de:"circa",tr:"yaklaşık"}
  ]},
  tema10: { ad: "Sağlık", kelimeler: [
    ...
    {de:"müde",tr:"yorgun"},{de:"der Hunger",tr:"açlık"},
    {de:"der Durst",tr:"susuzluk"},{de:"sich duschen",tr:"duş almak"},
    {de:"die Dusche",tr:"duş"},{de:"schlafen",tr:"uyumak"},
    ...
    {de:"der Doktor",tr:"doktor"},{de:"Was fehlt Ihnen?",tr:"Şikayetiniz nedir?"},
    {de:"Mir ist schlecht",tr:"Midem bulanıyor / Kendimi kötü hissediyorum"},
    ...
    {de:"Achtung",tr:"Dikkat!"},{de:"die Vorsicht",tr:"dikkat, ihtiyat"},
    {de:"die Hilfe",tr:"yardım"},{de:"Hilfe!",tr:"İmdat!"},
    {de:"der Notfall",tr:"acil durum"},{de:"die Polizei",tr:"polis"},
  ...
  tema11: { ad: "Tatil ve Seyahat", kelimeler: [
    ...
    {de:"der Abflug",tr:"uçuş kalkışı"},{de:"abfliegen",tr:"kalkmak (uçak)"},
    {de:"die Halbpension",tr:"yarım pansiyon"},{de:"die Vollpension",tr:"tam pansiyon"},
    {de:"der Prospekt",tr:"broşür"},{de:"ankommen",tr:"varmak"},
    {de:"der Zoll",tr:"gümrük"},{de:"die Unterkunft",tr:"konaklama"},
    {de:"das Zimmer",tr:"oda"},{de:"der Schlüssel",tr:"anahtar"},
    {de:"das Frühstück",tr:"kahvaltı"},{de:"der Aufenthalt",tr:"konaklama süresi"},
    {de:"buchen",tr:"rezervasyon yapmak"},{de:"das Ticket",tr:"bilet"},
    {de:"der Reiseführer",tr:"rehber (kişi veya kitap)"},{de:"die Landkarte",tr:"harita"},
  ...
  tema12: { ad: "Schreiben ve İletişim", kelimeler: [
    ...
    {de:"sprechen",tr:"konuşmak"},{de:"hören",tr:"duymak, dinlemek"},
    {de:"die Durchsage",tr:"anons, ilan"},{de:"das Gespräch",tr:"konuşma, görüşme"},
    {de:"auf Wiederhören",tr:"telefonda hoşça kalın"},{de:"die Adresse",tr:"adres"},
    {de:"die Postleitzahl",tr:"posta kodu"},{de:"der Computer",tr:"bilgisayar"},
